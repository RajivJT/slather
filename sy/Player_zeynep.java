...
public class Player implements slather.sim.Player {
	...
	*/
	...
	private Move leaderDefender(Cell player_cell, byte memory, Set<Cell> nearby_cells, Set<Pherome> nearby_pheromes){
	...
	private Move defender(Cell player_cell, byte memory, Set<Cell> nearby_cells, Set<Pherome> nearby_pheromes){
